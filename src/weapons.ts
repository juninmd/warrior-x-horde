// weapons.ts - Sistema de armas coletáveis
...
export function spawnWeapons(entities: Entities, canvasWidth: number, gameState: GameState): void {
  // Remover armas que já passaram
